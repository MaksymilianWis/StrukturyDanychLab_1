...
void runTestsDynamicArray(const unsigned numOfArrays) {
    ...
    do {
        ...
        case '1':
        {
            testingDynamicArray(numOfArrays, 10, 1, 1);
            break;
        }
        case '2':
        {
            testingDynamicArray(numOfArrays, 100, 2, 1);
            break;
        }
        case '3':
        {
            testingDynamicArray(numOfArrays, 1000, 3, 1);
            break;
        }
        case '4':
        {
            testingDynamicArray(numOfArrays, 2000, 4, 1);
            break;
        }
        case '5':
        {
            testingDynamicArray(numOfArrays, 4000, 5, 1);
            break;
        }
        case '6':
        {
            testingDynamicArray(numOfArrays, 8000, 6, 1);
            break;
        }
        case '7':
        {
            testingDynamicArray(numOfArrays, 16000, 7, 1);
            break;
        }
        case '8':
        {
            testingDynamicArray(numOfArrays, 32000, 8, 1);
            break;
        }
        case '9':
        {
            testingDynamicArray(numOfArrays, 64000, 9, 1);
            break;
        }
        case 'X':
        {
            testingDynamicArray(numOfArrays, 128000, 10, 1);
            break;
        }
        case 'A':
        {
            testingDynamicArray(numOfArrays, 10, 1, 0);
            testingDynamicArray(numOfArrays, 100, 2, 0);
            testingDynamicArray(numOfArrays, 1000, 3, 0);
            testingDynamicArray(numOfArrays, 2000, 4, 0);
            testingDynamicArray(numOfArrays, 4000, 5, 0);
            testingDynamicArray(numOfArrays, 8000, 6, 0);
            testingDynamicArray(numOfArrays, 16000, 7, 0);
            testingDynamicArray(numOfArrays, 32000, 8, 0);
            testingDynamicArray(numOfArrays, 64000, 9, 0);
            testingDynamicArray(numOfArrays, 128000, 10, 0);
            break;
        }
...
void runTestsLinkedList(const unsigned numOfLists, string type_of_list) {
    ...
    do {
        ...
        case 'A':
        {
            testingLinkedList(numOfLists, 10, 1, 0, type_of_list);
            testingLinkedList(numOfLists, 100, 2, 0, type_of_list);
            testingLinkedList(numOfLists, 1000, 3, 0, type_of_list);
            testingLinkedList(numOfLists, 2000, 4, 0, type_of_list);
            testingLinkedList(numOfLists, 4000, 5, 0, type_of_list);
            testingLinkedList(numOfLists, 8000, 6, 0, type_of_list);
            testingLinkedList(numOfLists, 16000, 7, 0, type_of_list);
            testingLinkedList(numOfLists, 32000, 8, 0, type_of_list);
            testingLinkedList(numOfLists, 64000, 9, 0, type_of_list);
            testingLinkedList(numOfLists, 128000, 10, 0, type_of_list);
            break;
        }
        default:
            cout << "Invalid choice. Please try again." << endl;
